...
- After making sure you have prepared all the environment, you only need to do one thing.

1. For Windows user, open your `git bash` and `cd` to this folder (or open `git bahs` in the folder) and type in `bash _setup.sh` and press enter.
